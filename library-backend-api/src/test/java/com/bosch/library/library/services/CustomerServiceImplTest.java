...
public class CustomerServiceImplTest {
    ...
    void testGetAllCustomersReturnsListOfAllCustomersWithLengthTwo() {
        ...
        Mockito.when(this.customerRepository.findAll(any(Specification.class))).thenReturn(this.customerList);

        // Retrieve all customers
        final int result = this.customerService.getAllCustomers(null).size();
    ...
    void testGetAllCustomersReturnsValidListOfAllCustomers() {
        ...
        // Retrieve all customers
        final List<CustomerDTO> result = this.customerService.getAllCustomers(null);
